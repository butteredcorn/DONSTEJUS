...
window.onload = function () {
  ...
  let gameConfig = {
    ...
    width: 1600,
    height: 900,
    scene: [preloadGame, playGame, Highscore],
...
class playGame extends Phaser.Scene {
  ...
  create() {
    ...
    scoreText = this.add.text(16, 16, 'score: ' + playerScore, { fontSize: '32px', fill: '#000' });
    this.timer = this.add.text(16, 64, 'arcade', { fontSize: '32px', fill: '#000' });
  ...
  update() {
    ...
    const end = new Date();
    const timeBonus = end - start;
    let time = timeBonus / 1000;
    this.timer.text = ('Time: ' + time.toFixed(2));
